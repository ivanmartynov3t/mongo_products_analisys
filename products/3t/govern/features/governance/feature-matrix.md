...
- S2: https://studio3t.com/ — homepage product descriptions (silo copy `data/3t/3t-website-2026/index.md` at silo commit `cde319c7`; at `b142fcc4` that path holds license.studio3t.com by mistake)
