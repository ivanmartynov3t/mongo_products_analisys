...
Place internal 3t product analyses here.

Path convention:

`products/3t/<product-name>/`

## Products

All six products are made by 3T Software Labs. Per studio3t.com, they organize into three tracks — Build, Pipeline, and Governed Access — but each is documented here as its own product.

| Product | Track | Product report |
| --- | --- | --- |
| Studio 3T | Build (Desktop IDE) | [product-report.md](studio-3t/product-report.md) |
