...
The homepage describes 3T Lens as a "Governed Data Workspace": "Safe, governed access to your MongoDB data for everyone who needs to see it but shouldn't change it. Query results automatically inherit your organization's access policies" (studio3t.com homepage, silo copy `data/3t/3t-website-2026/index.md` at silo commit `f1e28e8d`).
