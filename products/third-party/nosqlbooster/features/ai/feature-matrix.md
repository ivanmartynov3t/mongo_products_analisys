...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AI-nl-query | NL to query | Confirmed | S1: "natural language query generation." P1 gives a worked example: `Find movies directed by Christopher Nolan and released after 2005` → a generated `db.movies.find(...)` call. | Requires active Software Assurance — see `AI-plan-req`. | N/A | S1, S2, P1 | — |
