...
| AI-plan-req | AI Assistant is a named included capability on Navicat Premium and Navicat for MongoDB Enterprise pricing pages; not itemized for the Standard tier. | A rare case in this report where a primary source (Navicat's own store pages) directly backs the claim, rather than resting solely on the secondary research file. | Navicat Premium Price Plan, Navicat for MongoDB Price Plan (S2, S3) |
