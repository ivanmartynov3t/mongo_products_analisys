...
| Feature matrices | 35 `feature-matrix.md` files across all 8 product folders (3T Software Labs: Studio 3T, 3T Explore, 3T MCP, 3TL Bridge, 3T Lens, 3T Access; Third-Party: MongoDB Compass, VisuaLeaf) |
| Sub-feature IDs in dictionary | 334 total in `feature-dictionary.md` across all 11 feature areas |
