...
| GOV-008 | Lens policy violations | 3T Lens compliance score, violations list with acknowledgement, violation observability and retention |
| GOV-009 | Lens scheduled policy evaluation | 3T Lens scheduled `POLICY_EVALUATE` tasks with emailed results |
