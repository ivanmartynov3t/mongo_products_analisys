...
| Date | Change | Author |
|---|---|---|
| 2026-09-04 (4) | Weekly maintenance scan: inspected competitor release channels (Compass, NoSQLBooster v11.0 with embedded mongosh v2.8 / Node.js 22.x, DataGrip, Navicat, DBeaver). Confirmed all capabilities mapped to existing dictionary IDs. | Jules |
